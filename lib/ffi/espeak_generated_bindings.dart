...
class Espeak {
  ...
  Espeak(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _espeak_InitializePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Int32, ffi.Int, ffi.Pointer<ffi.Char>,
              ffi.Int)>>('espeak_Initialize');
  late final _espeak_Initialize = _espeak_InitializePtr
      .asFunction<int Function(int, int, ffi.Pointer<ffi.Char>, int)>();

  void espeak_SetSynthCallback(
    ffi.Pointer<t_espeak_callback> SynthCallback,
  ) {
    return _espeak_SetSynthCallback(
      SynthCallback,
    );
  }

  late final _espeak_SetSynthCallbackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<t_espeak_callback>)>>('espeak_SetSynthCallback');
  late final _espeak_SetSynthCallback = _espeak_SetSynthCallbackPtr
      .asFunction<void Function(ffi.Pointer<t_espeak_callback>)>();
  ...
  void espeak_SetUriCallback(
    ...
    return _espeak_SetUriCallback(
      UriCallback,
    );
  }

  late final _espeak_SetUriCallbackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<
                  ffi.NativeFunction<
                      ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Char>,
                          ffi.Pointer<ffi.Char>)>>)>>('espeak_SetUriCallback');
  late final _espeak_SetUriCallback = _espeak_SetUriCallbackPtr.asFunction<
      void Function(
          ffi.Pointer<
              ffi.NativeFunction<
                  ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Char>,
  ...
  void espeak_SetPhonemeCallback(
    ...
    return _espeak_SetPhonemeCallback(
      PhonemeCallback,
    );
  }

  late final _espeak_SetPhonemeCallbackPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Pointer<
                      ffi.NativeFunction<
  ...
  late final _espeak_SetPhonemeCallback =
      _espeak_SetPhonemeCallbackPtr.asFunction<
          void Function(
              ffi.Pointer<
                  ffi.NativeFunction<
                      ffi.Int Function(ffi.Pointer<ffi.Char>)>>)>();
  ...
  int espeak_Synth(
    ...
    int end_position,
    int flags,
    ffi.Pointer<ffi.UnsignedInt> unique_identifier,
    ffi.Pointer<ffi.Void> user_data,
  ) {
    return _espeak_Synth(
      text,
      size,
      position,
      position_type,
  ...
  late final _espeak_SynthPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Void>,
              ffi.Size,
              ...
              ffi.Pointer<ffi.Void>)>>('espeak_Synth');
  late final _espeak_Synth = _espeak_SynthPtr.asFunction<
      int Function(ffi.Pointer<ffi.Void>, int, int, int, int, int,
          ffi.Pointer<ffi.UnsignedInt>, ffi.Pointer<ffi.Void>)>();

  int espeak_Synth_Mark(
    ffi.Pointer<ffi.Void> text,
    int size,
    ffi.Pointer<ffi.Char> index_mark,
    int end_position,
    int flags,
    ffi.Pointer<ffi.UnsignedInt> unique_identifier,
    ffi.Pointer<ffi.Void> user_data,
  ) {
    return _espeak_Synth_Mark(
      text,
      size,
      index_mark,
      end_position,
  ...
  late final _espeak_Synth_MarkPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Void>,
              ffi.Size,
              ...
              ffi.UnsignedInt,
              ffi.Pointer<ffi.UnsignedInt>,
              ffi.Pointer<ffi.Void>)>>('espeak_Synth_Mark');
  late final _espeak_Synth_Mark = _espeak_Synth_MarkPtr.asFunction<
      int Function(ffi.Pointer<ffi.Void>, int, ffi.Pointer<ffi.Char>, int, int,
          ffi.Pointer<ffi.UnsignedInt>, ffi.Pointer<ffi.Void>)>();
  ...
  late final _espeak_KeyPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Char>)>>(
          'espeak_Key');
  late final _espeak_Key =
      _espeak_KeyPtr.asFunction<int Function(ffi.Pointer<ffi.Char>)>();
  ...
  late final _espeak_CharPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.WChar)>>('espeak_Char');
  late final _espeak_Char = _espeak_CharPtr.asFunction<int Function(int)>();

  int espeak_SetParameter(
    int parameter,
    int value,
    int relative,
  ) {
    return _espeak_SetParameter(
      parameter,
      value,
      relative,
    );
  ...
  late final _espeak_SetParameterPtr = _lookup<
          ffi.NativeFunction<ffi.Int32 Function(ffi.Int32, ffi.Int, ffi.Int)>>(
      'espeak_SetParameter');
  late final _espeak_SetParameter =
      _espeak_SetParameterPtr.asFunction<int Function(int, int, int)>();

  int espeak_GetParameter(
    int parameter,
    int current,
  ) {
    return _espeak_GetParameter(
      parameter,
      current,
    );
  }

  late final _espeak_GetParameterPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int32, ffi.Int)>>(
          'espeak_GetParameter');
  late final _espeak_GetParameter =
      _espeak_GetParameterPtr.asFunction<int Function(int, int)>();

  int espeak_SetPunctuationList(
    ffi.Pointer<ffi.WChar> punctlist,
  ) {
    return _espeak_SetPunctuationList(
      punctlist,
    );
  }

  late final _espeak_SetPunctuationListPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.WChar>)>>(
          'espeak_SetPunctuationList');
  late final _espeak_SetPunctuationList = _espeak_SetPunctuationListPtr
  ...
  void espeak_SetPhonemeTrace(
    ...
    return _espeak_SetPhonemeTrace(
      phonememode,
      stream,
    );
  }

  late final _espeak_SetPhonemeTracePtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Int, ffi.Pointer<FILE>)>>(
      'espeak_SetPhonemeTrace');
  late final _espeak_SetPhonemeTrace = _espeak_SetPhonemeTracePtr
      .asFunction<void Function(int, ffi.Pointer<FILE>)>();

  ffi.Pointer<ffi.Char> espeak_TextToPhonemes(
    ffi.Pointer<ffi.Pointer<ffi.Void>> textptr,
    int textmode,
    int phonememode,
  ) {
    return _espeak_TextToPhonemes(
      textptr,
      textmode,
      phonememode,
    );
  ...
  late final _espeak_TextToPhonemesPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Pointer<ffi.Void>>,
              ffi.Int, ffi.Int)>>('espeak_TextToPhonemes');
  late final _espeak_TextToPhonemes = _espeak_TextToPhonemesPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(
          ffi.Pointer<ffi.Pointer<ffi.Void>>, int, int)>();

  void espeak_CompileDictionary(
    ffi.Pointer<ffi.Char> path,
    ffi.Pointer<FILE> log,
    int flags,
  ) {
    return _espeak_CompileDictionary(
      path,
      log,
      flags,
    );
  ...
  late final _espeak_CompileDictionaryPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<FILE>,
              ffi.Int)>>('espeak_CompileDictionary');
  late final _espeak_CompileDictionary =
      _espeak_CompileDictionaryPtr.asFunction<
          void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<FILE>, int)>();

  ffi.Pointer<ffi.Pointer<espeak_VOICE>> espeak_ListVoices(
    ffi.Pointer<espeak_VOICE> voice_spec,
  ) {
    return _espeak_ListVoices(
      voice_spec,
    );
  }

  late final _espeak_ListVoicesPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Pointer<espeak_VOICE>> Function(
              ffi.Pointer<espeak_VOICE>)>>('espeak_ListVoices');
  late final _espeak_ListVoices = _espeak_ListVoicesPtr.asFunction<
      ffi.Pointer<ffi.Pointer<espeak_VOICE>> Function(
          ffi.Pointer<espeak_VOICE>)>();

  int espeak_SetVoiceByFile(
    ffi.Pointer<ffi.Char> filename,
  ) {
    return _espeak_SetVoiceByFile(
      filename,
    );
  }

  late final _espeak_SetVoiceByFilePtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Char>)>>(
          'espeak_SetVoiceByFile');
  late final _espeak_SetVoiceByFile = _espeak_SetVoiceByFilePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>)>();

  int espeak_SetVoiceByName(
    ffi.Pointer<ffi.Char> name,
  ) {
    return _espeak_SetVoiceByName(
      name,
    );
  }

  late final _espeak_SetVoiceByNamePtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Char>)>>(
          'espeak_SetVoiceByName');
  late final _espeak_SetVoiceByName = _espeak_SetVoiceByNamePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>)>();

  int espeak_SetVoiceByProperties(
    ffi.Pointer<espeak_VOICE> voice_spec,
  ) {
    return _espeak_SetVoiceByProperties(
      voice_spec,
    );
  }

  late final _espeak_SetVoiceByPropertiesPtr = _lookup<
          ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<espeak_VOICE>)>>(
      'espeak_SetVoiceByProperties');
  late final _espeak_SetVoiceByProperties = _espeak_SetVoiceByPropertiesPtr
      .asFunction<int Function(ffi.Pointer<espeak_VOICE>)>();

  ffi.Pointer<espeak_VOICE> espeak_GetCurrentVoice() {
    return _espeak_GetCurrentVoice();
  }

  late final _espeak_GetCurrentVoicePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<espeak_VOICE> Function()>>(
          'espeak_GetCurrentVoice');
  late final _espeak_GetCurrentVoice = _espeak_GetCurrentVoicePtr
      .asFunction<ffi.Pointer<espeak_VOICE> Function()>();

  int espeak_Cancel() {
    return _espeak_Cancel();
  }

  late final _espeak_CancelPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('espeak_Cancel');
  late final _espeak_Cancel = _espeak_CancelPtr.asFunction<int Function()>();

  int espeak_IsPlaying() {
    return _espeak_IsPlaying();
  }

  late final _espeak_IsPlayingPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function()>>('espeak_IsPlaying');
  late final _espeak_IsPlaying =
      _espeak_IsPlayingPtr.asFunction<int Function()>();

  int espeak_Synchronize() {
    return _espeak_Synchronize();
  }

  late final _espeak_SynchronizePtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('espeak_Synchronize');
  late final _espeak_Synchronize =
      _espeak_SynchronizePtr.asFunction<int Function()>();

  int espeak_Terminate() {
    return _espeak_Terminate();
  }

  late final _espeak_TerminatePtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('espeak_Terminate');
  late final _espeak_Terminate =
      _espeak_TerminatePtr.asFunction<int Function()>();

  ffi.Pointer<ffi.Char> espeak_Info(
    ffi.Pointer<ffi.Pointer<ffi.Char>> path_data,
  ) {
    return _espeak_Info(
      path_data,
    );
  ...
  late final _espeak_InfoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('espeak_Info');
  late final _espeak_Info = _espeak_InfoPtr.asFunction<
...
abstract class espeak_EVENT_TYPE {
  static const int espeakEVENT_LIST_TERMINATED = 0;
  static const int espeakEVENT_WORD = 1;
  static const int espeakEVENT_SENTENCE = 2;
  static const int espeakEVENT_MARK = 3;
  static const int espeakEVENT_PLAY = 4;
  static const int espeakEVENT_END = 5;
  static const int espeakEVENT_MSG_TERMINATED = 6;
  static const int espeakEVENT_PHONEME = 7;
  static const int espeakEVENT_SAMPLERATE = 8;
}

final class espeak_EVENT extends ffi.Struct {
  @ffi.Int32()
  external int type;

  @ffi.UnsignedInt()
  external int unique_identifier;

  @ffi.Int()
  external int text_position;

  @ffi.Int()
  external int length;

  @ffi.Int()
  external int audio_position;
...
abstract class espeak_POSITION_TYPE {
  static const int POS_CHARACTER = 1;
  static const int POS_WORD = 2;
  static const int POS_SENTENCE = 3;
}

abstract class espeak_AUDIO_OUTPUT {
  static const int AUDIO_OUTPUT_PLAYBACK = 0;
  static const int AUDIO_OUTPUT_RETRIEVAL = 1;
  static const int AUDIO_OUTPUT_SYNCHRONOUS = 2;
  static const int AUDIO_OUTPUT_SYNCH_PLAYBACK = 3;
}

abstract class espeak_ERROR {
  static const int EE_OK = 0;
  static const int EE_INTERNAL_ERROR = -1;
  static const int EE_BUFFER_FULL = 1;
  static const int EE_NOT_FOUND = 2;
}

typedef t_espeak_callback = ffi.NativeFunction<
    ffi.Int Function(
        ffi.Pointer<ffi.Short>, ffi.Int, ffi.Pointer<espeak_EVENT>)>;

abstract class espeak_PARAMETER {
  static const int espeakSILENCE = 0;
  static const int espeakRATE = 1;
  static const int espeakVOLUME = 2;
  static const int espeakPITCH = 3;
  static const int espeakRANGE = 4;
  static const int espeakPUNCTUATION = 5;
  static const int espeakCAPITALS = 6;
  static const int espeakWORDGAP = 7;
  static const int espeakOPTIONS = 8;
  static const int espeakINTONATION = 9;
  static const int espeakSSML_BREAK_MUL = 10;
  static const int espeakRESERVED2 = 11;
  static const int espeakEMPHASIS = 12;
  static const int espeakLINELENGTH = 13;
  static const int espeakVOICETYPE = 14;
  static const int N_SPEECH_PARAM = 15;
}

abstract class espeak_PUNCT_TYPE {
  static const int espeakPUNCT_NONE = 0;
  static const int espeakPUNCT_ALL = 1;
  static const int espeakPUNCT_SOME = 2;
}
...
const int ESPEAK_API_REVISION = 12;

const int espeakRATE_MINIMUM = 80;

const int espeakRATE_MAXIMUM = 450;

const int espeakRATE_NORMAL = 175;

const int espeakINITIALIZE_PHONEME_EVENTS = 1;

const int espeakINITIALIZE_PHONEME_IPA = 2;

const int espeakINITIALIZE_DONT_EXIT = 32768;

const int espeakCHARS_AUTO = 0;

const int espeakCHARS_UTF8 = 1;

const int espeakCHARS_8BIT = 2;

const int espeakCHARS_WCHAR = 3;

const int espeakCHARS_16BIT = 4;

const int espeakSSML = 16;

const int espeakPHONEMES = 256;

const int espeakENDPAUSE = 4096;

const int espeakKEEP_NAMEDATA = 8192;

const int espeakPHONEMES_SHOW = 1;

const int espeakPHONEMES_IPA = 2;

const int espeakPHONEMES_TRACE = 8;

const int espeakPHONEMES_MBROLA = 16;

const int espeakPHONEMES_TIE = 128;
